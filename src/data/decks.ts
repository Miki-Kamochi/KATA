...
export const DECKS: Deck[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      { word: "Right",     motion: "correct",  hint: "Arms overhead in a circle — you got it right",
        i18n: { zh: { word: "对", hint: "双臂在头顶圈成圆形" }, ja: { word: "合ってる", hint: "腕を頭上で丸く——正解" } } },
      { word: "Yes",       motion: "correct",  hint: "Make the O sign with your whole body",
        i18n: { zh: { word: "是", hint: "用全身做出O的手势" }, ja: { word: "はい", hint: "全身でOのサインを作る" } } },
      { word: "Wrong",     motion: "wrong",    hint: "Cross your arms in a big X",
        i18n: { zh: { word: "错误", hint: "双臂交叉成大X" }, ja: { word: "間違い", hint: "腕を大きくXに交差する" } } },
      { word: "No",        motion: "wrong",    hint: "Arms crossed — that's a no",
        i18n: { zh: { word: "不", hint: "双臂交叉——表示不" }, ja: { word: "いいえ", hint: "腕を交差——ノーのサイン" } } },
      { word: "False",     motion: "wrong",    hint: "Make an X with your arms — false!",
        i18n: { zh: { word: "假", hint: "双臂做出X——错误！" }, ja: { word: "偽り", hint: "腕でXを作る——偽り！" } } },
      { word: "Think",     motion: "thinking", hint: "Hand to chin — deep in thought",
        i18n: { zh: { word: "思考", hint: "手托下巴——深思" }, ja: { word: "考える", hint: "手を顎に当てる——深く考える" } } },
      { word: "Wonder",    motion: "thinking", hint: "Pause and ponder — hand to your chin",
        i18n: { zh: { word: "好奇", hint: "停下来思考——手托下巴" }, ja: { word: "不思議", hint: "立ち止まって考える——顎に手を当てる" } } },
      { word: "Maybe",     motion: "thinking", hint: "Not sure yet — strike a thinking pose",
        i18n: { zh: { word: "也许", hint: "还不确定——摆出思考的姿势" }, ja: { word: "たぶん", hint: "まだわからない——考えるポーズ" } } },
      { word: "Open",      motion: "t_pose",   hint: "Stretch arms straight out to both sides",
        i18n: { zh: { word: "开放", hint: "双臂向两侧伸直" }, ja: { word: "オープン", hint: "両腕を両側に伸ばす" } } },
      { word: "Free",      motion: "t_pose",   hint: "Arms wide open — feel the freedom",
        i18n: { zh: { word: "自由", hint: "双臂大张——感受自由" }, ja: { word: "自由", hint: "両腕を大きく広げる——自由を感じる" } } },
      { word: "Balance",   motion: "t_pose",   hint: "Arms out like a tightrope walker",
        i18n: { zh: { word: "平衡", hint: "双臂伸展如走钢丝" }, ja: { word: "バランス", hint: "綱渡りのように腕を広げる" } } },
      { word: "Respect",   motion: "bow",      hint: "Bow forward — show respect",
        i18n: { zh: { word: "尊重", hint: "向前鞠躬——表示尊重" }, ja: { word: "尊重", hint: "前にお辞儀する——敬意を示す" } } },
      { word: "Gratitude", motion: "bow",      hint: "Bow deep — give thanks",
        i18n: { zh: { word: "感恩", hint: "深深鞠躬——表达感谢" }, ja: { word: "感謝", hint: "深くお辞儀する——感謝を伝える" } } },
      { word: "Humble",    motion: "bow",      hint: "Lower yourself — stay humble",
        i18n: { zh: { word: "谦逊", hint: "低下身子——保持谦逊" }, ja: { word: "謙虚", hint: "身をかがめる——謙虚でいる" } } },
    ],
  },
];
